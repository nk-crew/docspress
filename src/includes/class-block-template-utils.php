...
class DocsPress_Block_Template_Utils {
    ...
    public static function gutenberg_build_template_result_from_post( $post ) {
        ...
        if ( ! $terms ) {
            return new \WP_Error( 'template_missing_theme', __( 'No theme is defined for this template.', '@@text_domain' ) );
        }
    ...
    public static function convert_slug_to_title( $template_slug ) {
        switch ( $template_slug ) {
            case 'single-docs':
                return __( 'Single DocsPress', '@@text_domain' );
            case 'archive-docs':
                return __( 'Archive DocsPress', '@@text_domain' );
            default:
